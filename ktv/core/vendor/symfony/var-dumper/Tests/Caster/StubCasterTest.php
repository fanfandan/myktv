...
<foo></foo><bar><span class=sf-dump-note>array:1</span> [<samp>
  <span class=sf-dump-home>0</span> => "<a href="javascript;"
</samp>]
</bar>
EODUMP;
...
EODUMP;
    ...
    public function testClassStubWithNotExistingClass()
    {
        ...
        $expectedDump = <<<'EODUMP'
<foo></foo><bar><span class=sf-dump-note>array:1</span> [<samp>
  <span class=sf-dump-home>0</span> => "<span class=sf-dump-str title="Symfony\Component\VarDumper\Tests\Caster\NotExisting
